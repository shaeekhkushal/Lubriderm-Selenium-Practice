...
class Homepage:
    ...
    def our_bestsellers_section(self):
        try:
            ...
            click_on_product_card3_image = WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located((By.XPATH, HomepageLocators.product3_card_image)))
            time.sleep(1)
            print("Product name Text:", click_on_product_card3_image.text)
            time.sleep(1)
            ...
            time.sleep(1)
            print("Product name Text:", click_on_product_card3_name.text)
            time.sleep(1)
            ...
            # time.sleep(1)
            # print("CTA Text:", click_on_buy_now_cta3.text)
            # time.sleep(1)
    ...
    def skin_concerns_section(self):
        try:
            ...
            time.sleep(1)
            print("Section title is:", scroll_to_skin_concerns.text)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_all_skin_concerns.text)
            time.sleep(1)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_skin_concerns1_cta.text)
            time.sleep(1)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_skin_concerns2_cta.text)
            time.sleep(1)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_skin_concerns3_cta.text)
            time.sleep(1)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_skin_concerns4_cta.text)
            time.sleep(1)
            ...
            print("skin_concerns_section element not found within the specified time.")
        time.sleep(2)
        return self
    ...
    def related_content_section(self):
        try:
            ...
            time.sleep(1)
            print("Section title is:", scroll_to_related_content.text)
            ...
            print("Sub copy Text:", grab_related_content_header1_text.text)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_related_content1_cta.text)
            time.sleep(1)
            ...
            print("Sub copy Text:", grab_related_content_header2_text.text)
            ...
            time.sleep(1)
            print("CTA Text:", click_on_related_content2_cta.text)
            time.sleep(1)
            ...
            print("related_content_section element not found within the specified time.")
        time.sleep(2)
        return self
